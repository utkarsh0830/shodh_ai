...
VALUES
    (1, 1, 'SUMA', 'Simple Sum', 'Read two integers, print their sum', 100),
    (2, 1, 'FACT', 'Factorial', 'Read N, print N!', 100);

INSERT INTO test_case (problem_id, input_data, expected_output, sample_case) VALUES
                                                                                 (1, '2 3\n', '5', TRUE),
                                                                                 (1, '100 250\n', '350', FALSE),
                                                                                 (2, '5\n', '120', TRUE),
                                                                                 (2, '1\n', '1', FALSE),
